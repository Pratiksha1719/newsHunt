      ...
      <div class="container">
        <div class="row">
            <div class="col-md-8">
				...
				<?php 
				$auth_id=$_GET['aid'];
				 $sql1="select * from post join user on 
				 post.author =user.user_id 
				 where post.author={$auth_id}";
			  $result1=mysqli_query($conn,$sql1)or die("query failmed");
			  ...
			  $result=mysqli_query($conn,$sql)or die("query failedcat");
				  ...
				  while($row=mysqli_fetch_assoc($result)){
					   ...
					   ?>
                        <div class="post-content">
                            <div class="row">
                                <div class="col-md-4">
                                    <a class="post-img" href="single.phpid=<?php echo $row['post_id'];?>"><img src="admin/upload/<?php echo $row['post_img'];?>" alt=""/></a>
                                </div>
                                <div class="col-md-8">
